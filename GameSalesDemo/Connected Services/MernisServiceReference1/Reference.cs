...
namespace MernisServiceReference1
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference1.KPSPublicSoap>, MernisServiceReference1.KPSPublicSoap
    {
        ...
        public System.Threading.Tasks.Task<MernisServiceReference1.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(
            long TCKimlikNo, string Ad, string Soyad, GameSalesDemo.Gamer gamer, int DogumYili)
        {
        ...
        internal bool TCKimlikNoDogrulaAsync(long gamerNationalId, Func<string> toUpper1, Func<string> toUpper2, int year)
        {
            throw new NotImplementedException();
        }

        internal bool TCKimlikNoDogrulaAsync(string gamerNationalId, Func<string> toUpper1, Func<string> toUpper2, int year)
        {
            throw new NotImplementedException();
        }
